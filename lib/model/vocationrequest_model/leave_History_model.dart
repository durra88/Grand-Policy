class LeaveHistoryModel {
  ...
  LeaveHistoryModel.fromJson(Map<String, dynamic> json) {
    sNo = json['sNo'] == null ? 0 : json['sNo'].toInt();
  ...
  static List<LeaveHistoryModel> toListOfModel(List<dynamic> data) {
    return data.map((data) => LeaveHistoryModel.fromJson(data)).toList();
  }
