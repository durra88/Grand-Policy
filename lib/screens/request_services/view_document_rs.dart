...
class GetDocumentRequestServices extends StatelessWidget {
  int id;
  GetDocumentRequestServices({Key? key, required this.id}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    documentController.fetchRequestServicesDocument(id);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        leading: BackButton(onPressed: (() {
          Get.offAll(RequestHistoriesScreen(false));
        })),
        backgroundColor: kMainColor,
        elevation: 0.0,
        titleSpacing: 0.0,
