...
class GetDocumentExcuse extends StatelessWidget {
  int id;
  GetDocumentExcuse({Key? key, required this.id}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    documentController.fetchExcuseDocument(id);
        ...
        body: Obx(() => connectivityController.connectionStatus.value == 0
            ...
            : Container(
                ...
                child: ListView.builder(
                    itemCount: documentController.documentModel.length,
                    itemBuilder: (context, index) {
                      return documentController.documentLoader.value
                          ...
                          : documentController.documentModel.isEmpty
                              ...
                              : InkWell(
                                  onTap: () {
                                    if (documentController.documentModel[index]
                                            .downloadState.value ==
                                        ViewState.retrived) {
