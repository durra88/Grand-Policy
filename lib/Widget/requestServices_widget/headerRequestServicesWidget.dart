...
class HeaderRequestServicesHistoryWidget extends StatelessWidget {
  const HeaderRequestServicesHistoryWidget({
    Key? key,
    required this.name,
  ...
  final String name, status, requestDetail, departement, requestType;
      ...
      children: [
        ListTile(
          ...
          trailing: Container(
            ...
            child: Center(
              child: Text(status == "Cancel" ? "Canceled" : status,
